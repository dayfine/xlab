...
class InMemoryDataStore(DataStore):
    ...
    def add(self, data_entry: DataEntry):
        ...
        self._data[key].append(data_entry)
        self._data[key].sort(key=lambda e: e.timestamp.ToDatetime())
